"""
Django settings for tenicons project.
...
WSGI_APPLICATION = 'tenicons.wsgi.application'
...
# Google Cloud Storage (Website data storage)
...
GS_CREDENTIALS = service_account.Credentials.from_service_account_file(str(BASE_DIR/'GS_CREDENTIALS.json'))
